...
public class ProductDao {
	public void create(Products product) {
		...
		try {
			String sql = "insert into products(productName, productPrice,stockInHand,reOrderLevel,categoryId) values(?,?,?,?,?)";
	...
	public void edit(Products product) {
		...
		Connection conn = pool.getConnection();
		try {
			String sql = "update products set productName = ?, productPrice = ?,stockInHand=?,reorderLevel=?,categoryId=? where productId = ?";
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setString(1, product.getProductName());
	...
	public static void main(String argsp[]) {
		...
		Products product0 = new Products("nokia", 2000, 1, 2, 401);
		Products product1 = new Products("nokia", 2000, 1, 2, 401);
		Products product2 = new Products("nokia", 2000, 1, 2, 401);
		Products product3 = new Products("nokia", 2000, 1, 2, 401);
		Products product4 = new Products("nokia", 2000, 1, 2, 401);
