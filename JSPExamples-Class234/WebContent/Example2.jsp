...
<HTML>
    ...
    <BODY >
        <CENTER>
            ...
            <jsp:setProperty name="employee" property="dept" param="dept" />
            <jsp:setProperty name="employee" property="desig"  param="desig" />
            <jsp:setProperty name="employee" property="doj" param="doj" />
            <jsp:setProperty name="employee" property="basic" param="basic" />
            <BR>
